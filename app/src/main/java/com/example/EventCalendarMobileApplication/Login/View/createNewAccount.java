    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCreateNewAccountButton.setOnClickListener(view -> {
            ...
            try{
                ...
                loginViewModel.createAccount(username, password, phoneNumber, success -> {
                    if (success) {
                        // Displays Success Message
                        Toast.makeText(this, "Account Successfully Created", Toast.LENGTH_LONG).show();

                        // Returns to Login Screen
                        Intent EnterMonthlyCalendarIntent = new Intent(createNewAccount.this, LoginActivity.class);
                        ...
                        Toast.makeText(this, "Invalid username, password, or phone number", Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (Exception e){
                    Intent RefreshIntent = new Intent(createNewAccount.this, createNewAccount.class);
